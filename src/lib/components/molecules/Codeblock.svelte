...
<div class="flex flex-col rounded-xl bg-primary">
	<div class="flex justify-between py-2 rounded-t-xl px-4 md:px-6 items-center bg-[#0B192F]">
	...
	<div class="p-4 md:p-6 text-base md:text-xl">
		{#if code}
			{#if lang}
				<pre
